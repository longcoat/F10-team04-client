  ...
  return (
    ...
    {!isNext?
      ...
      <S.Container>
        ...
        style={{position:"relative" , top:"50px", right:"80px", fontSize:"25px"}}/>
          <S.TitleBox>
            <S.Title>RunGether</S.Title>
          </S.TitleBox>
          <S.ImgBox>
          ...
          <S.SexButtonBox>
            ...
            onClick={props.onClickLeft} >남성</S.SexButton1>
            <S.SexButton2
            type="button"
          ...
          <S.ExerciseButtonBox>
            ...
            >Beginner</S.ExerciseButton1>
            <S.ExerciseButton2
            type="button"
            isActive={props.level2}
            onClick={props.onClickLevel2}
            >Amateur</S.ExerciseButton2>
            <S.ExerciseButton3
            type="button"
            isActive={props.level3}
            onClick={props.onClickLevel3}
            >Pro</S.ExerciseButton3>
          </S.ExerciseButtonBox>
          <S.CompleteButtonBox>
            <S.CompleteButton onClick={props.onClickSubmit}>가입완료</S.CompleteButton>
          </S.CompleteButtonBox>
        </S.JoinForm>
      </S.Container>}
    </>
