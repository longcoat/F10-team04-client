    ...
    return(
        ...
        <S.MainContents2>
            <S.ContentsBox2>
                ...
                <S.Contents_title>서로 의욕을 복돋아주는 엑티브한 커뮤니티</S.Contents_title>
                <S.Contents_2>
                상호간의 커뮤니티를 만들어서 방장과 함께 1대1 대화를 통해 멤버에 합류하며 즐겁게 소통해나가는 rungetger 입니다.    
                </S.Contents_2>
        <S.MemberBtn>
            <S.Btn>
            COMMUNITY
    ...
    <S.Wrapper_2>
      ...
      <S.MainContents2>
        <S.ContentsBox2>
          ...
          <S.Contents_2>
            상호간의 커뮤니티를 만들어서 방장과 함께 1대1 대화를 통해 멤버에
            합류하며 즐겁게 소통해나가는 rungetger 입니다.
          </S.Contents_2>
          <S.MemberBtn>COMMUNITY</S.MemberBtn>
        </S.ContentsBox2>
        <S.ImgBox
          style={{
            backgroundImage:
